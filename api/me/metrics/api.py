...
async def get_my_monthly_metrics(
    ...
    if num == 1:
        return [
            {"label": "1월", "me": 14, "all": 20},
            {"label": "2월", "me": 45, "all": 40},
            {"label": "3월", "me": 75, "all": 60},
            {"label": "4월", "me": 50, "all": 50},
            {"label": "5월", "me": 84, "all": 66},
            {"label": "6월", "me": 90, "all": 44},
        ]
    else:
        return [
            {"label": "7월", "me": 100, "all": 33},
            {"label": "8월", "me": 82, "all": 46},
            {"label": "9월", "me": 47, "all": 23},
            {"label": "10월", "me": 90, "all": 49},
            {"label": "11월", "me": 77, "all": 80},
            {"label": "12월", "me": 100, "all": 70},
        ]
